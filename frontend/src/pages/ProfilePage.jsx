...
const ProfilePage = () => {
    ...
    const handleImageUpLoad = async (e) => {
      ...
      reader.readAsDataURL(file);  // here we use FileReader to read the file as String
        ...
        <div className='bg-base-300 rounded-xl p-6 space-y-8'>
          ...
          <div className='flex flex-col items-center gap-4'>
            <div className='relative'>
              <img src={ selectImage || authUser.profilepic || "/avatar.png"} alt="Profile" className='size-32 rounded-full object-cover border-4' />
